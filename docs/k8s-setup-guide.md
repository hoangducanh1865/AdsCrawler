...
Vì Minikube hoạt động trong một môi trường cô lập (máy ảo riêng), nó sẽ **không nhìn thấy** các Docker image bạn vừa build trên máy thật (Windows). Cần "gửi" chúng vào trong máy ảo bằng 2 lệnh sau:
